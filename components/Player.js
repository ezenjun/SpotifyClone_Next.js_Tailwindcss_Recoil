...
import { PlayIcon, PauseIcon, RewindIcon, SwitchHorizontalIcon, FastForwardIcon, ReplyIcon} from '@heroicons/react/solid';
    ...
    return (
        <div className='h-24 bg-gradient-to-b from-black to-gray-800 text-white grid grid-cols-3 text-xs md:text-base px-2 md:px-8'>
            ...
            <div className='flex items-center space-x-3 md:space-x-4 justify-end'>
                <VolumeOffIcon onClick={()=>volume>0 && setVolume(0)} className='button'/>
                <input 
                className='w-14 md:w-28 text-pink-800' 
